...
def main(args):
    ...
    # train_ds = combined_brain_1mm.CombinedBrainDataset(root_dir=args.root_dir, type="train")
    # val_ds = combined_brain_1mm.CombinedBrainDataset(root_dir=args.root_dir, type="val")
