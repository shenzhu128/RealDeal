...
def main(args):
    ...
    # train_ds = brain_5_datasets_1mm.CombinedBrainDataset(root_dir=args.root_dir, type="train")
    # print(train_ds.data_paths[:2])
    # # val_ds = combined_brain_1mm.CombinedBrainDataset(root_dir=args.root_dir, type="val", corrected=True)
    # val_ds = brain_5_datasets_1mm.CombinedBrainDataset(root_dir=args.root_dir, type="val")
    # print(val_ds.data_paths)
    # train_ds = lidc.LIDCDataset(root_dir=args.root_dir, type="train")
    # val_ds = lidc.LIDCDataset(root_dir=args.root_dir, type="val")

    train_ds = datasets.hcp_3d.HCP3DDataset1mm(root_dir=args.root_dir, type="train")
    val_ds = datasets.hcp_3d.HCP3DDataset1mm(root_dir=args.root_dir, type="val")
