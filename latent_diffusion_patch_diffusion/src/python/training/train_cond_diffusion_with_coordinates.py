...
import training_functions_with_coordinates
import wandb
from generative.networks.schedulers import DDPMScheduler

# from generative.networks.nets import DiffusionModelUNet
from models.diffusion_model_unet import DiffusionModelUNet, ModifiedDiffusionModelUNetWithCoordinateEmbedding
...
def main(args):
    ...
    diffusion = ModifiedDiffusionModelUNetWithCoordinateEmbedding(**config["ldm"].get("params", dict()))
    ...
    val_loss = training_functions_with_coordinates.train_cond_diffusion(
        model=diffusion,
        # stage1=stage1,
        scheduler=scheduler,
